...
public class CalculatorController {
    ...
    private void buttonController(ActionEvent event) throws ScriptException {
        ...
        if ("1234567890+-*/.".contains(input)) expression += input;
            ...
            if (input.equals("+/-")) result = Double.parseDouble(result.toString()) * -1;
            else if (input.equals("%")) result = Double.parseDouble(result.toString()) / 100;
...
//https://docs.gluonhq.com/getting-started/#intellij-plugin